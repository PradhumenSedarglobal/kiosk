...
const CustomizationSection = () => {
  ...
  const { customization, productInfo, headerData, materialList,  isCustomizationLoading,stepsArray } = useSelector((state) => state.customization);
  ...
  return (
    <Box sx={{ height: { xxs: '100dvh', xs: '100dvh', sm: "100dvh", md: "100vh" }, overflow: { lg: "hidden", md: 'hidden', sm: "auto", xs: "auto", xxs: "auto" } }}>
